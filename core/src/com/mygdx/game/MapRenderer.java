...
public class MapRenderer {
    ...
    private void createAnimations () {
        ...
        this.tile = new TextureRegion(new Texture(Gdx.files.internal("core\\assets\\tile.png")), 0, 0, 20, 20);

        Texture bobTexture = new Texture(Gdx.files.internal("core\\assets\\bob.png"));
